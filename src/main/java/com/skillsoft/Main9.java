...
import com.skillsoft.config.IOTDeviceBeanConfig3;
...
public class Main9 {
    public static void main(String[] args) {
        ApplicationContext applicationContext = new AnnotationConfigApplicationContext(IOTDeviceBeanConfig3.class);
